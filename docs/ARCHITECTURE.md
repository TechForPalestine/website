...
|---|---|---|
| **Notion** | `src/store/notionClient.ts` (axios) + a few routes use `@notionhq/client` directly | Events, FAQ, ideas, agenda/speakers, E4P pledge signatories, endorsement requests — 7 databases total, see [NOTION.md](NOTION.md) |
