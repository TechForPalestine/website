...
| Doc                                | Covers                                                                                                                          |
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| [ARCHITECTURE.md](ARCHITECTURE.md) | Rendering model, middleware chain, data source map, env var resolution, the abandoned `-new` redesign, directory layout         |
...
| [PROJECTS.md](PROJECTS.md)         | ProjectHub integration for `/projects`, and how it differs from the unrelated `project-proxy` form endpoint                     |
