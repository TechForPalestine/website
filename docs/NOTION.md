...
| Community Calls            | `NOTION_COMMUNITY_CALLS_DB_ID` | `fetchCommunityCalls()` in `src/store/notionClient.ts`                                                                                                                         | `community-call.astro`, `community-call-old.astro`, `CommunityCallBanner.astro`                              |
