...
const locations = [
    ...
    { name: "Doha", coords: [25.276987, 51.5200] },
    ...
    { name: "Krakow", coords: [50.0647, 19.9450] },
...
const greenCircleMarker = new L.Icon({
    iconUrl:
