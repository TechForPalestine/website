...
export default function LondonGatheringSpeakers({ initialSpeakers = [] }: LondonGatheringSpeakersProps) {
                ...
                {speakers.map((speaker) => (
                    <Grid item xs={6} sm={4} md={2.4} key={speaker.id}>
                        ...
                        >
                            ...
                            />
                            <Typography variant="h6" className="!font-bold !text-base !mb-1 text-gray-900">
                                {speaker.name}
                            </Typography>
