...
import { sanitizeUrl, sanitizeEmail, type ProjectItem } from "./projectData";
...
export const SOCIAL_FIELDS: SocialField[] = [
  { key: "websiteUrl", label: "Website", icon: <GlobeIcon /> },
  { key: "githubUrl", label: "GitHub", icon: <GitHubIcon fontSize="small" /> },
  { key: "twitterUrl", label: "Twitter / X", icon: <TwitterIcon fontSize="small" /> },
  ...
  { key: "mastodonUrl", label: "Mastodon", icon: <MastodonIcon /> },
  { key: "blueskyUrl", label: "Bluesky", icon: <BlueskyIcon /> },
  { key: "tiktokUrl", label: "TikTok", icon: <TikTokIcon /> },
  { key: "signalUrl", label: "Signal", icon: <SignalIcon /> },
  { key: "discordUsername", label: "Discord", icon: <DiscordIcon />, isDiscord: true },
...
export function getSocialHref(field: SocialField, project: ProjectItem): string {
  if (field.isEmail) {
    const email = sanitizeEmail(project[field.key] as string | undefined);
