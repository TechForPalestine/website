...
function getStyles(designSystem: boolean): StyleSet {
  ...
  return {
    ...
    input: "text-sm text-ink",
    button: "text-[15px] font-bold rounded-full",
    helper: "text-xs leading-relaxed text-ink-secondary",
    link: "text-[13px] font-bold text-[#157A3E]",
    tierIntro: "text-sm leading-relaxed text-ink-secondary",
    tierTitle: "text-base font-bold text-ink",
    tierDescription: "text-sm leading-relaxed text-ink-secondary",
    tierBenefit: "text-sm text-ink-secondary",
    tierNote: "text-xs leading-relaxed text-ink-secondary",
