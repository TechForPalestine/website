...
export default function MembershipDues() {
  const [showCalculator] = useState<boolean>(() => {
    ...
    localStorage.setItem(
      "membership_ab_variant",
      assigned ? "Calculator" : "No Calculator"
    );
    return assigned;
  });
      ...
      <div className="mt-3 grid grid-cols-1 items-start gap-6 min-[810px]:grid-cols-[1fr_340px]">
        ...
        <div className="flex flex-col gap-3">
          <div className="rounded-[16px] border border-butter bg-page p-4">
            ...
            <p className="ts-body-small mb-2 text-ink-secondary leading-relaxed">
              Tech for Palestine aims for inclusivity. Please contact{" "}
              <a href="mailto:membership@techforpalestine.org" className="text-brand underline hover:text-brand-hover">
            ...
            <ul className="mb-2 space-y-1 pl-3">
              {[
                ...
                <li key={item} className="ts-body-small flex items-baseline gap-2 text-ink-secondary">
                  <span className="mt-1.5 block h-1 w-1 shrink-0 rounded-full bg-brand" aria-hidden="true" />
                  {item}
                </li>
              ))}
            </ul>
            <p className="ts-body-small mb-2 text-ink-secondary leading-relaxed">
              ...
              after signup and we will ensure that future donations are processed through our gift aid partner.
            </p>
            <p className="ts-body-small text-ink-secondary leading-relaxed">
          ...
          <div className="rounded-[16px] border border-butter bg-cream p-4">
            ...
            <p className="ts-body-small text-ink-secondary leading-relaxed">
              ...
              <a href="mailto:membership@techforpalestine.org" className="font-semibold text-brand underline hover:text-brand-hover">
                membership@techforpalestine.org
              </a>
              !
            </p>
